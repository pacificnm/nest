//! Startup option parsing for Tauri applications.
...
/// Parsed Tauri startup flags (CLI overrides config).
#[derive(Debug, Clone, Default)]
pub struct TauriStartupOptions {
