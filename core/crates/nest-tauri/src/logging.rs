//! Merge logging defaults, config section, and Tauri startup flags.
...
/// Builds the final logging configuration for Tauri startup.
///
/// Desktop hosts default to file logging only while the window is active.
