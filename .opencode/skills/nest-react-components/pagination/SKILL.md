---
name: nest-react-pagination
description: Use when working with the Pagination component from @nest/components – page navigation UI.
---
...
<Pagination count={50} siblingCount={3} boundaryCount={2} defaultPage={25} />
```
## Accessibility
...
- For mobile, **use** `hideFirstLast` and `hidePrevNext` to save space
- Always pair pagination with text indicating current position ("Showing 1‑10 of 100")
