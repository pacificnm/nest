---
name: nest-react-typography
description: Use when working with the Typography React component from @nest/components — rendering headings, body text, subtitles, captions, and overlines with variant-based styling, color, alignment, truncation, gutter bottom spacing, and component overrides.
---
