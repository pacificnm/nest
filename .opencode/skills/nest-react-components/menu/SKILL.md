---
name: nest-react-menu
description: Use when working with the Menu component from @nest/components – dropdown panel, menu items, and file‑style menu bar.
---

# Menu
A dropdown menu panel, plus `MenuItem`, `MenuDivider`, and a `MenuBar` / `MenuBarItem` pair for File/Edit‑style top menus. All exported from this module.
