---
name: nest-react-buttongroup
description: Use when working with the ButtonGroup React component from @nest/components – a visual grouping of related buttons.
---
