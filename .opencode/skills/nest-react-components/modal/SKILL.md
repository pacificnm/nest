---
name: nest-react-modal
description: Use when working with the Modal React component from @nest/components – a focus-trapping overlay for dialogs and important interactions.
---
...
<Modal open={open} onClose={handleClose}>
  <div className="p-6">
    <Typography variant="h6" className="mb-2">Confirm Delete</Typography>
...
```tsx
<Modal open={open} onClose={handleClose} closeOnOutsideClick={false} closeOnEscape={false}>
  <div className="p-6">
    <Typography variant="h6">Required Action</Typography>
    <Typography variant="body2">You must complete this form before closing.</Typography>
    {/* Form fields */}
  </div>
</Modal>
```
...
- Focus moves automatically to first focusable element.
...
- Provide clear exit: button, Escape, or outside click.
- Size properly: fit without excessive scrolling.
- Use for important interactions; avoid overuse for routine content.
- Consider alternatives like Popover or inline expansion for non-blocking needs.
