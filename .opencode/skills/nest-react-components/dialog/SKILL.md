---
name: nest-react-dialog
description: Use when working with the Dialog React component from @nest/components – a modal overlay for confirmations, forms, or critical information.
---
