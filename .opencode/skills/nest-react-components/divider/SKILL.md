---
name: nest-react-divider
description: Use when working with the Divider component from @nest/components – a visual separator.
---
...
<Paper>
  ...
  <Divider />
  <div className="p-4"><p>Body content</p></div>
  <Divider />
  <div className="p-4 bg-nest-muted/10"><p className="text-sm">Footer</p></div>
</Paper>
```
### Toolbar Divider
```tsx
