---
name: nest-react-list
description: Use when working with the List React components from @nest/components — rendering navigation menus, contact lists, settings panels, message inboxes, interactive list items with ListItemButton, and configuring icons, avatars, text content, dense mode, and selected/disabled states.
---
