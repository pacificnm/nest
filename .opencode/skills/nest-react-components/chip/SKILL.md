---
name: nest-react-chip
description: Use when working with the Chip React component from @nest/components — rendering tags, labels, filters, contact chips, status indicators, deletable items, clickable selections, or configuring chip variants, colors, sizes, icons, and delete behavior.
---
