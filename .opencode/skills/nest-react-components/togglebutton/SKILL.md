---
name: nest-react-togglebutton
description: Use when working with the ToggleButton and ToggleButtonGroup components from @nest/components – toggle-able button groups.
---
...
```tsx
<ToggleButton value="bold" aria-label="Bold"><BoldIcon /></ToggleButton>
```
