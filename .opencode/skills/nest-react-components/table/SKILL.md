---
name: nest-react-table
description: Use when working with the Table React components from @nest/components — rendering tabular data, headers, body rows, footers, numeric columns, sticky headers, hoverable rows, cell alignment, colSpan/rowSpan, and configuring sortable or responsive tables.
---
