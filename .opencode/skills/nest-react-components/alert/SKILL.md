---
name: nest-react-alert
description: Use when working with the Alert React component from @nest/components — displaying success, error, warning, or info messages with optional custom icon, dismiss action, and style variants.
---
