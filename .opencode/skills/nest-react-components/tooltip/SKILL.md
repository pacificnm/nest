---
name: nest-react-tooltip
description: Use when working with the Tooltip React component from @nest/components — displaying hover/focus help text for icons, buttons, form fields, configuring placement, delays, arrow, controlled open state, and rich content.
---
