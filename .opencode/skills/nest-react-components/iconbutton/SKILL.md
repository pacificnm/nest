---
name: nest-react-iconbutton
description: Use when working with the IconButton React component from @nest/components – a compact, icon‑only button.
---
...
|------|--------|---------|--------|
| `size` | `small` | `medium` | `size-8` / `size-10` / `size-12` |
| `color` | `default` | `primary` | Icon color + hover tint |
