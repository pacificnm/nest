---
name: nest-react-skeleton
description: Use when working with the Skeleton React component from @nest/components – a lightweight placeholder for loading states.
---
...
- Uses `role="presentation"` by default.
- Pulse animation is subtle and respects WCAG motion.
- Pair with a live region when loading: e.g., `<div aria-live="polite" aria-busy="true"><Skeleton /><p>Loading...</p></div>`.
