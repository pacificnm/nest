---
name: nest-react-badge
description: Use when working with the Badge React component from @nest/components — rendering notification counts, status dots, unread indicators, badges overlaid on icons or buttons, configuring size, color variants, and dot mode.
---
