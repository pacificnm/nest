---
name: nest-react-avatar
description: Use when working with the Avatar React component from @nest/components — rendering user profile pictures, contact avatars, initials fallback, icons, avatar groups, status indicators, configuring size, shape variants, image sources, and accessibility.
---
