---
name: nest-react-drawer
description: Use when working with the Drawer React component from @nest/components – a slide‑out panel for navigation, settings, or contextual content.
---
