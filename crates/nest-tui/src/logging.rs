//! Merge logging defaults, config section, and TUI startup flags.
...
/// Builds the final logging configuration for TUI startup.
///
/// TUI hosts never log to stdout while the terminal UI is active.
